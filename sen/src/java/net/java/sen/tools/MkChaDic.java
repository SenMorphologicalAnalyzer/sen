    ...
    public static void main(String args[]){
        ...
        try {
            CSVParser csvparser = new CSVParser
                (new FileInputStream(rb.getString("text_connection_file")),rb.getString("dic.charset"));
            String t[];
            int line = 0;
            ...
            // if you want check specified morpheme, you uncomment and modify following line:
            /*
              System.out.print("22=");
              dm3.getById(22);
              System.out.print("368=");
              dm3.getById(368);

              System.out.println(dm3.getDicId("½õ»?,½ª½õ»?,*,*,*,*,¤Í"));
              DictionaryMaker.debug = true;
              System.out.println(dm3.getDicId("½õ»?,½ª½õ»?,*,*,*,*,¤Í"));
              System.out.println(dm3.getDicIdNoCache("½õ»?,½ª½õ»?,*,*,*,*,¤Í"));
            */
        ...
        short default_cost = (short)Integer.parseInt
            (rb.getString("default_connection_cost"));

        ///////////////////////////////////////////
        //
        // Step3. Writing Connection Matrix
        //
        log.info("(3/7): writing conection matrix (" 

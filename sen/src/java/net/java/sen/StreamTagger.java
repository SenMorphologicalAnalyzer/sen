...
public class StreamTagger {
    ...
    /**
     * Construct new StreamTagger. Currently only support
     * Locale.JAPANESE.
     *
     * @param reader Reader to add tag.
     * @param locale Locale to generate morphological analyzer.
     * 
     */ 
    public StreamTagger(Reader reader, Locale locale) 

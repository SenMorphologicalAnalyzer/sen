...
public  class JapaneseTokenizer extends Tokenizer 
{
	...
	public JapaneseTokenizer(String tokenFile, 
                             String doubleArrayFile,
                             String posInfoFile,
                             String charset
                     ) throws IOException{
        super(tokenFile, doubleArrayFile, posInfoFile, charset);
    }
    ...
    public int getCharClass (char c){
        ...
        if (type == Character.CONNECTOR_PUNCTUATION ||
           ...
           type == Character.END_PUNCTUATION) {
                System.out.println("punctuation char = "+c);
    ...
    public Node lookup (char c[], int begin) throws IOException
    {
        ...
        if ((resultNode!=null) && (char_class[0] == HIRAGANA || char_class[0] == KANJI))
            return resultNode;
        ...
        case OTHER:
            ...
            break; 
        default:
            begin3 = skipCharClass (c, begin2 + 1, end, char_class[0]); // group by same class
            break; 
        }
